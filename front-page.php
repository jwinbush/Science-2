...
<main role="main" class="main-content">
    ...
    <div class="about-wrapper container">
      <div class="about-content">
        <div class="about-header">
          <h2 class="about-title">Exceptional Design</h2>
        ...
        <a class="btn btn-blue" href="/about-us">Learn More<span></span>
        </a>
      </div>
    </div>
  </section>
  ...
  <section class="team">
    <div class="team-wrapper container">
      <h2 class="team-title">The Design Firm</h2>
      <div class="team-cards">
        <div class="card">
          <img src="<?php bloginfo('template_directory'); ?>/assets/images/lee-gerrietts.png');"
        ...
        <div class="card"><img src="<?php bloginfo('template_directory'); ?>/assets/images/wesley-stutter.png');"
  ...
  <section class="contact">
    <div class="contact-wrapper container">
      <div class="contact-content">
        <h2 class="contact-title">Bespoke Solutions<br><span>For Your Unique Project</span></h2>
